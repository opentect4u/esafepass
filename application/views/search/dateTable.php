...
<div class="row page-titles">
        <div class="col-md-8 col-8 align-self-center">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="<?php echo site_url('search/byDate');?>">Search By Date</a></li>
        ...
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="<?php echo site_url('search/archive');?>" class="form-horizontal">
                        <input type="hidden" value="<?php echo $from_dt; ?>" name= "from_dt">
                        <input type="hidden" value="<?php echo $to_dt; ?>" name= "to_dt">
                        <button class="btn btn-success" type="submit" id= "submit" >Archive</button>
                        <button class="btn btn-success" type="button" id= "excel" onclick="location.href='<?php echo site_url('search/exportDt?from='.$from_dt.'&to='.$to_dt.''); ?>'" >Export to excel</button>
                    </form>
