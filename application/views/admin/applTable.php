                            ...
                            <tbody> 
                                ...
                                ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-nowrap" style= "text-align: center;" id="del" class="del">
                                                
                                                <a class="del" href="<?php echo site_url('adminApp/delete?appl_no='.$a_dtls->appl_no.'&sl_no='.$a_dtls->sl_no.''); ?>"
                                                title="Delete" target= "blank"
                                                onclick="return confirm('Are you sure you want to delete this item?');"
                                                >
                                                    <i class="fas fa-trash m-r-10 del" aria-hidden="true" style="color: #f13508"></i>
