    <div class="row page-titles">
        ...
        <div class="col-md-6 col-8 align-self-center">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#">Search by Passport</a></li>
        ...
        <div class="card card-outline-info">
            ...
            <div class="card-body">
                ...
                <form class="form-horizontal" 
                    id="form"
                    method="post" 
                    action="<?php echo site_url('search/bypassort');?>"
                >
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="control-label">Passport No<font color= "red"> *</font></label>
