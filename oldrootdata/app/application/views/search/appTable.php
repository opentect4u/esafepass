...
<div class="row page-titles">
        <div class="col-md-8 col-8 align-self-center">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="<?php echo site_url('search/byAppNo');?>">Search by Application</a></li>
        ...
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="<?php echo site_url('search/archiveApp');?>" class="form-horizontal">
                        <input type="hidden" value="<?php echo $from_no; ?>" name= "from_no">
                        <input type="hidden" value="<?php echo $to_no; ?>" name= "to_no">
                        <button class="btn btn-success" type="submit" id= "submit" >Archive</button>
                        <button class="btn btn-success" type="button" id= "excel" onclick="location.href='<?php echo site_url('search/exportApp?from='.$from_no.'&to='.$to_no.''); ?>'" >Export to excel</button>
                    </form>
